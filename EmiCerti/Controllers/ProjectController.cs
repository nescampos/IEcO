        ...
        public async Task<IActionResult> Create(CreateProjectFormModel Form)
        {
            ...
            try
            {
                ...
                if(receipt != null)
                {
                    ...
                    {
                         Verifier = Form.Verifier, TokenQuantity = Form.TokenQuantity, Certifier = Form.Certifier,
                         CreatedAt = DateTime.UtcNow, Location = Form.Location, Name = Form.Name, OffsetCategory = Form.OffsetCategory,
                         ProjectType = Form.ProjectType, Protocol = Form.Protocol, ReductionsPeriodEnd = Form.ReductionsPeriodEnd,
                         ReductionsPeriodStart = Form.ReductionsPeriodStart, ReductionstCO2e = Form.ReductionstCO2e,
                         TokenSymbol = Form.TokenSymbol, TokenId = receipt.Token.AccountNum, Enable = true, WebSite = Form.WebSite
                         , ImageUrl = Form.ImageUrl, OwnerAccountNumber = Form.OwnerAccountNumber,
                        Expiration = Form.Expiration, HBARsent = false
                    };
